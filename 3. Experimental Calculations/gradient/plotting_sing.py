...
csv_path = "grad_sing\\tracking_output_7.csv"
...
save_plot = True
output_plot = "speed_vs_distance_single_7.pdf"
output_csv = "grad_sing\\speed_vs_distance_single_7.csv"

# ============================================================
# LOAD PREPROCESSING PARAMETERS FROM TRACKING SCRIPT
# ============================================================

x0, y0, w0, h0, scale, zoom = np.load(preprocess_file)
...
# ============================================================
# LOAD FRAME AND APPLY SAME PREPROCESSING AS TRACKING
# ============================================================
...
# Same preprocessing as tracking:
# full frame -> scaled frame -> cropped ROI -> zoomed ROI
...
# ============================================================
# CLICK 4 CORNERS OF 1 cm SQUARE
# ============================================================

points = []
calib_frame = frame_zoom.copy()
...
def click_event(event, x, y, flags, param):
    if event == cv2.EVENT_LBUTTONDOWN and len(points) < 4:
        ...
        cv2.imshow("Calibration - cropped and zoomed", calib_frame)
        print(f"Point {len(points)}: ({x}, {y})")

cv2.imshow("Calibration - cropped and zoomed", calib_frame)
cv2.setMouseCallback("Calibration - cropped and zoomed", click_event)
...
# Average side length of selected 1 cm square
...
def sliding_velocity(time_s, distance_mm, window_s=2.0, min_points=5):
    ...
    return np.array(time_mid), np.array(distance_cm_mid), np.array(speed_mm_s)
